...
<html>
<head>
	<title>LearnWell - online learning system</title>
...
<body>
    ...
    <section class="section-2">
		...
		<h4 style="text-align: center;">You should login first to explore courses : </h4>
		<h2 style="text-align: center;">
			<a href="login.php">Explore Courses</a>
		</h2>
    ...
    <footer class="main-footer">
      <h4>RCD2013C - LearnWell&copy;2024</h4>
    </footer>

    <!-- Include Public Chat Bot -->
    <?php include "PublicChatBot.php"; ?>
